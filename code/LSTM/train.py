...
y=[]
n = 0
lstm = LSTM(lr=lr,time_steps=time_steps,len_of_vocab=len_of_vocab,mean=mean,std=std)
...
while n<=epoches:
	if start_ptr+time_steps > len_of_dataset:
		...
		lstm.zero_grad()
		loss,dWi,dWf,dWz,dWo,dWout,dRi,dRf,dRz,dRo,dPi,dPo,dPf,dbi,dbo,dbf,dbz,dbout,h_prev,c_prev=lstm.forward_backward_pass\
